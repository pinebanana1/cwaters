...
public class ItchyNoseFragment extends SymptomFragment{
    ...
    public void moveToNext() {
        writeToFile();
        NavHostFragment.findNavController(ItchyNoseFragment.this).navigate(
                R.id.action_itchyNoseFragment_to_sneezingFragment
        );
    }
}
